...
2. `git clone git://github.com/Penske-Media-Corp/stashboard.git`
3. Open the SDK, choose `File > Add Existing Application...` and select the `stashboard` folder *inside the cloned repository*
